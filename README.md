...
> *“Waqf x AI — building Islamic economic infrastructure for the next generation.”*

-----

### 🧭 Who I Am

- 🏛️ **CEO** at [Amal Produktif](https://amalproduktif.or.id) — Nazhir Wakaf Produktif, Bandung
- 🤖 **Founder** at [SAIF Digital Holdings](https://saif.co.id) — Shariah AI Frontier *(Shariah-compliant AI ecosystem)*
- 🌐 **Head of Innovation & Digitalization** at Asosiasi Nazhir Indonesia (ANI)
- ✍️ Writing about Waqf × AI × Technology at [ridlo.id](https://ridlo.id)
- 📍 Bandung, Indonesia
...
|WAQF_CHAIN                                        |Blockchain ledger for transparent waqf asset recording                       |🔬 Research|
